              ...
              <div className="position-relative">
                ...
                >
                  <div className="text-end">
                    <p className="small fw-black text-dark mb-0 lh-1">{user.name.split(' ')[0]}</p>
                  </div>
                  <div className={`rounded-circle border border-2 p-0.5 transition-all ${profileOpen ? 'border-success' : 'border-dark/5'}`} style={{ width: '42px', height: '42px' }}>
                    <img src={user.avatar} alt="Avatar" className="w-100 h-100 rounded-circle shadow-sm" />
                  </div>
                </div>
        ...
        <div className="mx-auto" style={{ maxWidth: '1200px' }}>
          ...
          <section className="mb-5 py-4 text-center">
            ...
            <div className="row g-3 g-md-4">
              ...
              <div className="col-12 col-md-4">
                <QuickAction title="View Rewards" desc="Claim your eco-perks" icon={<Trophy />} variant="outline" />
              </div>
            </div>
          </section>
