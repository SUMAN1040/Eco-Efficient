    ...
    return (
      <div className="admin-modal-overlay d-flex align-items-center justify-content-center p-4">
        <div className="bg-white rounded-5 p-5 text-center shadow-lg position-relative premium-card" style={{ maxWidth: '500px', width: '100%' }}>
          ...
          <h2 className="fw-bold mb-3 text-dark">Request Received!</h2>
          <p className="text-muted mb-4 fs-5" style={{ lineHeight: '1.6' }}>
            Your application for a City Manager / Admin account has been securely submitted along with your credentials. 
            Our compliance team will review your organization's details and email you within 24-48 hours.
          </p>
          <button onClick={onClose} className="btn btn-primary btn-lg rounded-pill px-5 py-3 fw-bold shadow-sm w-100 magnetic-btn">
            Return to Homepage
          </button>
        </div>
      </div>
  ...
  return (
    <div className="admin-modal-overlay d-flex align-items-center justify-content-center p-4">
      <div className="bg-white rounded-5 overflow-hidden shadow-lg position-relative d-flex premium-card" style={{ maxWidth: '1000px', width: '100%', minHeight: '600px' }}>
        ...
        {/* Visual Sidebar with Elegant Pattern */}
        <div className="d-none d-lg-flex flex-column justify-content-between p-5 text-white position-relative overflow-hidden admin-sidebar" style={{ width: '45%' }}>
          <div className="position-relative z-2">
            ...
            <h2 className="display-6 fw-bolder mb-3 text-white">Admin Access</h2>
            <p className="text-white opacity-75 fs-5" style={{ lineHeight: '1.6' }}>
              Join the Eco-Efficient network as a City Manager or Sustainability Officer. Control your local ecosystem with powerful tools.
            </p>
          </div>
          <div className="position-relative z-2 mt-4">
            <ul className="list-unstyled mb-0 d-flex flex-column gap-3 opacity-75">
              <li className="d-flex align-items-center gap-3"><CheckCircle size={18} /> Manage city ecosystems</li>
              <li className="d-flex align-items-center gap-3"><CheckCircle size={18} /> Analyze waste data metrics</li>
              <li className="d-flex align-items-center gap-3"><CheckCircle size={18} /> Configure collection points</li>
            </ul>
          </div>
        </div>
      ...
      <style>{`
        ...
        .admin-sidebar {
          ...
          background-image: radial-gradient(circle at 0% 0%, #3a602c 0%, transparent 50%), radial-gradient(circle at 100% 100%, #1a3a25 0%, transparent 50%);
        ...
        .premium-input:focus {
          ...
          box-shadow: 0 0 0 4px rgba(45, 74, 34, 0.1);
        }
        ...
        .upload-dropzone.has-file {
          border-style: solid; border-color: var(--primary); background: #f0fdf4;
        }
        .file-input-hidden {
        ...
        .magnetic-btn:hover {
          transform: translateY(-2px); box-shadow: 0 10px 20px rgba(45, 74, 34, 0.2) !important;
        }
        .magnetic-btn:active {
